...
def get_parser():
    ...
    parser.add_argument('--test_ratio', type=float, default=0.3, help="Ratio of test samples")
    parser.add_argument('--patch_size', type=int, default=9, help="Patch size for the hyperspectral image")
    # parser.add_argument('--patch_size', type=int, default=1, help="Patch size for the hyperspectral image")
