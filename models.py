...
class TransferNet(nn.Module):
    def __init__(self, num_class, base_net='resnet50', transfer_loss='mmd', use_bottleneck=True, bottleneck_width=256, max_iter=1000, input_channels=3,**kwargs):
        super(TransferNet, self).__init__()
        self.num_class = num_class
        self.base_network = backbones.get_backbone(base_net, input_channels=input_channels)  # 修改输入通道数
    ...
    def get_features(self,x):
        features = self.base_network(x)
        return self.bottleneck_layer(features)
